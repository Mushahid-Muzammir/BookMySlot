...
const AdminSidebar: React.FC<React.PropsWithChildren<{}>> = ({ children }) => {
  ...
  return (
    <aside className= {`flex flex-col gap-3 top-0 bg-white h-screen transition-all duration-300 fixed relative ${expanded ? 'w-[15%]' : 'w-[5%]'}`}>
        <nav className="h-full flex flex-col bg-white shadow-sm">
         <div className="flex justify-between px-2 py-3 items-center mb-15">         
