...
namespace BookMySlot.Data
{
    ...
    // Imagine AppDbContext is your database assistant.Before it can work must give it a set of instructions(like the database name, credentials, and other setup info).
